  ...
  Savings.find({
    ...
    if (savingsEntries) {
      res.status(200).json({
        ...
        totalSavingsDineOutAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.DINE_OUT),
        totalSavingsGiftAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.GIFT),
        totalSavingsGroceryAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.GROCERY),
        totalSavingsHouseAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.HOUSE),
        totalSavingsMembershipAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.MEMBERSHIP),
        totalSavingsOtherAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.OTHER),
        totalSavingsTransportationAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.TRANSPORTATION),
        totalSavingsTravelAmount: getTotalSavingsAmount(savingsEntries, EXPENSE_TYPE.TRAVEL)
      });
    } else {
      res.status(200).json({
